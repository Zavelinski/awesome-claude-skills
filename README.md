...
- [scheduled-sop-runner](https://github.com/Zavelinski/claude-code-scheduled-sop-runner) - Turns a repeatable SOP into a self-checking scheduled routine that verifies each run and notifies you only when something fails.
