...
- [adversarial-verify](https://github.com/Zavelinski/claude-code-adversarial-verify) - Proves a change works by trying to break it: writes and runs falsification tests, then returns a binary PASS/FAIL/INCONCLUSIVE verdict.
